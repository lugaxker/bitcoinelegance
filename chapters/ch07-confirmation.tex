...
Cette attaque doit être distinguée de la censure\sendnote{La résistance à la censure est décrite dans le chapitre~\ref{ch:incensurabilite}.}, qui consiste à refuser de confirmer des transactions selon un critère arbitraire, et qui repose sur des incitations \emph{extérieures} à l'économie de Bitcoin.
