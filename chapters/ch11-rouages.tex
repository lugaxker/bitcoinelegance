...
Bitcoin forme ainsi une machine qui peut sembler, à première vue, complexe. Cette complexité relative s'explique par ses objectifs et par les évènements qui ont jalonné son histoire technique. Son but premier -- être une monnaie -- est à l'origine de la représention des bitcoins en circulation par des sorties transactionnelles non dépensées, qui est à la fois plus facile à paralléliser et plus confidentielle. De plus, la volonté de Satoshi d'automatiser divers mécanismes lui a fait intégrer un véritable système de programmation au sein du prototype.
